...
Add-Content "c:\windows\system32\drivers\etc\hosts" "        192.168.38.102    dc2019.windomain.local"

# Force DNS resolution of the domain
ping /n 1 dc2019.windomain.local
...
try {
  ...
  New-ADOrganizationalUnit -Name "Servers" -Server "dc2019.windomain.local"
}
...
try {
  ...
  New-ADOrganizationalUnit -Name "Workstations" -Server "dc2019.windomain.local"
}
